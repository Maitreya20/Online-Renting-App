...
class TenantVehicleListAdapter(var vehicleList: List<VehicleListDetails>) :
    RecyclerView.Adapter<TenantVehicleListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder) {
            ...
            //binding.imgTenantVehicle.setImageResource(R.drawable.bike_icon)
            ...
            binding.cdVehicleList.setOnClickListener {
                if (vehicleListDetails.pStatus.equals("1")) {
                    val intent = Intent(binding.root.context, TenantVehicleDetails::class.java)
